...
def geneticmoead(y, weight, zmin, popSon, sonSize, popSize, partern, distanceIndex, iteration, F, cr, trainDate, trainTag, testDate, testTag, feature, passageway, trainRow, testRow, feature_low, passageway_low):
    ...
    with open('result_moead'+str(feature_low)+'_'+str(passageway_low)+'.txt', 'w') as f:
        for i in range(sonSize):
...
def ploturf(y, sonSize, feature_low, passageway_low):
    ...
    plt.show()
    plt.savefig('moead'+str(feature_low)+'_'+str(passageway_low)+'.png', dpi=500)
...
if __name__ == '__main__':
    ...
    geneticmoead(y, weight, zmin, popSon, sonSize, popSize, partern, distanceIndex, iteration,
                 F, cr, trainDate, trainTag, testDate, testTag, feature, passageway, trainRow, testRow, feature_low, passageway_low)
    print(time.ctime())
